...
var EqEditor_init = () => ({
  ...
  Panel: {
    ...
    close: function (a) {
      ...
      if (a !== undefined && a !== null) a.firstChild.style.outline = 'none';
    },
    hoverdiv: null,
    hlock: false,
  ...
  init: function (SID, obj, resize, editorid) {
    ...
    EqEditor.OnClick('undobutton',
      function (e) {
        EqEditor.targetArea.undo();
      });
    EqEditor.OnClick('redobutton',
      function (e) {
        EqEditor.targetArea.redo();
      });
    EqEditor.OnChange('bg',
      function (e) {
        var b = EqEditor.$('bg');
        if (b) {
    ...
    EqEditor.OnChange('format',
      function (e) {
        var action = false;
        EqEditor.setFormat(EqEditor.getFormat());
      });
    EqEditor.OnChange('fontsize',
      function () {
