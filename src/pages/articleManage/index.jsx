...
class Article extends Component {
    ...
    // 添加文章
    addArticle = () => {
        router.push('/articleManage/articleEdit');
    }
    ...
    render() {
        const { articleTotal, dataList, limit, dataTotal } = this.state;
                    ...
                    <Card bordered={false}>
                        <Row>
                            ...
                            <Col sm={6} xs={24} className={styles.typeBox} style={{ borderRight: 'none' }}>
                                <p className={styles.typeTitle}><Icon type="coffee" /> 生活</p>
