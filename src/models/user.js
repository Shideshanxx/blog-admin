...
const UserModel = {
    ...
    effects: {
        ...
        *updateAvatar({ payload, callback }, { call }) {
        ...
        *getUserArticleList({ payload, callback }, { call }) {
            const response = yield call(getUserArticleList, payload);
            if (response.code === 200) {
                callback(response)
            }
        },
        *getUserArticleTotal({ payload, callback }, { call }) {
        ...
        *uploadCode({ payload, callback }, { call }) {
        ...
        *uploadRewardCode({ payload, callback }, { call }) {
